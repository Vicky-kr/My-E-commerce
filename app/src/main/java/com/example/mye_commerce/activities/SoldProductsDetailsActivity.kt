...
/*
        ...
        tv_sold_product_details_date = findViewById(R.id.tv_order_details_date)
        ...
        tv_sold_details_address_type = findViewById(R.id.tv_address_type)
        tv_sold_details_full_name = findViewById(R.id.tv_my_order_details_full_name)
        tv_sold_details_address = findViewById(R.id.tv_address_details)
        tv_sold_details_additional_note = findViewById(R.id.tv_my_order_details_additional_note)
        tv_sold_details_other_details = findViewById(R.id.tv_my_order_details_other_details)
        tv_sold_details_mobile_number = findViewById(R.id.tv_my_order_details_mobile_number)
        tv_sold_product_sub_total = findViewById(R.id.tv_order_details_sub_total)
        tv_sold_product_shipping_charge = findViewById(R.id.tv_order_details_shipping_charge)
        tv_sold_product_total_amount = findViewById(R.id.tv_order_details_total_amount)
*/
...
//        setUI()
    ...
    private fun setUI(){
        ...
        tv_sold_product_details_date.text = orderDateTime
